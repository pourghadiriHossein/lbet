                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">آدرس پشتیبانی سایت</label>
                                        <div class="col-lg-10">
                                            <input value="گیلان-رشت-یخسازی" disabled type="text"  oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="test" class="form-control" placeholder="آدرس پشتیبانی سایت">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">تغییر آدرس پشتیبانی سایت به</label>
                                        <div class="col-lg-10">
                                            <input value="{{old('title')}}" type="text"  oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="address" class="form-control" placeholder="آدرس پشتیبانی سایت را وارد کنید">
                                        </div>
                                    </div>
                            ...
                            <a href="{{route('APTPage15SiteAddress')}}"><input type="submit" class="finish btn btn-danger" value="تایید" /></a>
                        </div>
                    </section>
                </div>
            </div>
