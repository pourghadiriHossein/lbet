                ...
                <div class="container">
                    ...
                    <div   class="col-xs-12 col-sm-12 col-md-12 table-responsive">
                        ...
                        <table id="orderTable" class="table table-striped">
                            <thead>
                            <tr>
                                <th style="text-align: right">شناسه پورسانت</th>
                                <th style="text-align: right">کران پایین پورسانت</th>
                                <th style="text-align: right">کران بالا پورسانت</th>
                                <th style="text-align: right">پورسانت</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>{{App\Models\Tools::persianNumber('100000')}} تومان </td>
                                    <td>{{App\Models\Tools::persianNumber('1000000')}} تومان </td>
                                    <td>{{App\Models\Tools::persianNumber('50000')}} تومان </td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">حذف پورسانت</h4>
                                                </div>
                                                <div class="modal-body">آیا از این عمل اطمینان دارید؟
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>{{App\Models\Tools::persianNumber('200000')}} تومان </td>
                                    <td>{{App\Models\Tools::persianNumber('2000000')}} تومان </td>
                                    <td>{{App\Models\Tools::persianNumber('30000')}} تومان </td>
                                    <td> <a class="label label-warning" href="">ویرایش</a>
                                        <a class="label label-danger" data-toggle="modal" href="#myModal2">حذف</a>
                                    </td>
