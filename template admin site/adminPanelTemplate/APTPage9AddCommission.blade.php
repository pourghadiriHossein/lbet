...
@section('content')
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">کران پایین پورسانت</label>
                                        <div class="col-lg-10">
                                            <input value="{{old('min_price')}}" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="min_price" class="form-control" placeholder="کران پایین پورسانت">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">کران بالا پورسانت</label>
                                        <div class="col-lg-10">
                                            <input value="{{old('max_price')}}" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="max_price" class="form-control" placeholder="کران بالا پورسانت">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">فی پورسانت</label>
                                        <div class="col-lg-10">
                                            <input value="{{old('price')}}" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="price" class="form-control" placeholder="پورسانت">
                                        </div>
                                    </div>
                            ...
                            <a href="{{route('APTPage8VisitCommission')}}"><input type="submit" class="finish btn btn-danger" value="تایید" /></a>
    ...
    <script>
        ...
        function showCity(element) {
            ...
            var id = document.getElementById("region").options[document.getElementById("region").selectedIndex].value;
            var link = "http://localhost/marketing/city/GetCitiesByRegion/"+id;
