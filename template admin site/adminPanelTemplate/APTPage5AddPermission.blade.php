                            ...
                            <div class="form">
                                ...
                                <form class="form-horizontal" action="" method="post" data-toggle="validator" id="user-form">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">نوع فعالیت</label>
                                        <div class="col-lg-10">
                                            <input value="{{old('name')}}" type="text" required="required" name="name" class="form-control" placeholder="نوع فعالیت">
                                        </div>
                                    </div>
                                ...
                                <a href="{{route('APTPage4VisitPermissions')}}"><input type="submit" class="finish btn btn-success" value="ذخیره" /></a>
                            </div>
