                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label"> تصویر لوگو</label>
                                        <div class="col-lg-10">
                                            <img src="{{asset('/')}}assets/images/logo_Black.png" alt="">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">تغییر تصویر لوگو</label>
                                        <div class="col-lg-10">
                                            <input type="file"  oninvalid="this.setCustomValidity('تغییر تصویر  نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')"  name="image" class="form-control" >
                                        </div>
                                    </div>
                            ...
                            <a href="{{route('APTPage16SiteLogo')}}"><input type="submit" class="finish btn btn-danger" value="تایید" /></a>
                        </div>
                    </section>
                </div>
            </div>
