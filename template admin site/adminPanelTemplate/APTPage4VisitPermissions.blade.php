                    ...
                    <div   class="col-xs-12 col-sm-12 col-md-12 table-responsive">
                        ...
                        <table id="orderTable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone" style="text-align: right">دستور محدود سازی</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a class="label label-success" href="">ویرایش</a> </td>
                                    <td>  <a class="label label-danger" data-toggle="modal" href="#myModal1">حذف</a></td>
                                ...
                                <tr>
                                    ...
                                    <td> <a class="label label-success" href="">ویرایش</a> </td>
                                    <td>  <a class="label label-danger" data-toggle="modal" href="#myModal2">حذف</a></td>
                                    ...
                                    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                    <h4 class="modal-title">حذف  دسترسی محدود</h4>
                                                </div>
                                                <div class="modal-body">
                                                    ایا از این عمل اطمینان دارید؟
